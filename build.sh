...
gcc audio.c -lm -O3 && ./a.out 96000 600 | ffmpeg -f s16le -ar 96000 -ac 1 -i - -ab 192000 -y sound-96000.m4a
gcc audio.c -lm -O3 && ./a.out 16000 600 | ffmpeg -f s16le -ar 16000 -ac 1 -i - -ab 19000 -y sound-16000.m4a
